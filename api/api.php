        ...
        foreach ($MaisEscalados as $subArray) {
            ...
            foreach ($TodasInformacoes['atletas'] as $todas) {
                ...
                if ($info == $subArray['Atleta']['atleta_id']) {
                    ...
                    echo '<span class="badge badge-success">' . "Escalados por " . $subArray['escalacoes'] . ' Cartoleiros' . '</span>'; // Exibe a posição do atleta

                    echo '<div class="fw-bold">' . '<img src="' . $foto . '" class="img-fluid" alt="Responsive image" width="70" height="70" align="left">' . "<b>" . $i . 'º ' . $subArray['Atleta']['apelido'] . '</b></div>'; // Exibe o nome do atleta
                    echo '<img src="' . $subArray['escudo_clube'] . '" class="img-fluid" alt="Responsive image" width="15" height="15" align="">' . " - " . $subArray['clube_nome'] . '<br>'; // Exibe o nome do clube do atleta
                    echo '<b>Pos - ' . $subArray['posicao'] . '</b>'; // Exibe a posição que o atleta joga
                    echo '<span class="badge badge-warning" align="left">' . 'Custa C$ ' . $todas['preco_num'] . ' e valoriza com ' . $todas['minimo_para_valorizar'] . ' pts' . '</span>'; // Exibe a posição do atleta
                    echo '</div>';
                    echo '</li>';
                    echo '</ol>';
